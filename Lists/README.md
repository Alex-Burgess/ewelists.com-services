...
This is a sample template for ListsApi - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name listsapi --tail
```
...
```bash
aws cloudformation delete-stack --stack-name listsapi
```
