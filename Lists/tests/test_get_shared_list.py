...
def list_query_response():
    response = [
        ...
        {"PK": {"S": "LIST#12345678-list-0001-1234-abcdefghijkl"}, "SK": {"S": "RESERVATION#12345678-prod-0001-1234-abcdefghijkl#12345678-user-0003-1234-abcdefghijkl#12345678-resv-0004-1234-abcdefghijkl"}, "reservationId": {"S": "12345678-resv-0004-1234-abcdefghijkl"}, "listId": {"S": "12345678-list-0001-1234-abcdefghijkl"}, "listOwnerId": {"S": "12345678-user-0001-1234-abcdefghijkl"}, "listTitle": {"S": "Child User1 1st Birthday"}, "name": {"S": "Test User3"}, "email": {"S": "test.user3@gmail.com"}, "productId": {"S": "12345678-prod-0001-1234-abcdefghijkl"}, "productType": {"S": "products"}, "userId": {"S": "12345678-user-0003-1234-abcdefghijkl"}, "quantity": {"N": "1"}, "reservedAt": {"N": "1573739584"}, "state": {"S": "reserved"}},
        ...
        {"PK": {"S": "LIST#12345678-list-0001-1234-abcdefghijkl"}, "SK": {"S": "RESERVATION#12345678-prod-0002-1234-abcdefghijkl#12345678-user-0002-1234-abcdefghijkl#12345678-resv-0003-1234-abcdefghijkl"}, "reservationId": {"S": "12345678-resv-0003-1234-abcdefghijkl"}, "listId": {"S": "12345678-list-0001-1234-abcdefghijkl"}, "listOwnerId": {"S": "12345678-user-0001-1234-abcdefghijkl"}, "listTitle": {"S": "Child User1 1st Birthday"}, "name": {"S": "Test User2"}, "email": {"S": "test.user2@gmail.com"}, "productId": {"S": "12345678-prod-0002-1234-abcdefghijkl"}, "productType": {"S": "products"}, "userId": {"S": "12345678-user-0002-1234-abcdefghijkl"}, "quantity": {"N": "1"}, "reservedAt": {"N": "1573739584"}, "state": {"S": "reserved"}}
    ]
...
class TestGenerateListObject:
    def test_generate_list_object(self, list_query_response):
        ...
        expected_product2 = {
            "12345678-user-0002-1234-abcdefghijkl": [
                {"productId": "12345678-prod-0002-1234-abcdefghijkl", "name": "Test User2", "email": "test.user2@gmail.com", "userId": "12345678-user-0002-1234-abcdefghijkl", "quantity": 1, "state": "purchased", "reservationId": '12345678-resv-0002-1234-abcdefghijkl', "listId": '12345678-list-0001-1234-abcdefghijkl', "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "listTitle": 'Child User1 1st Birthday', "productType": 'products'},
                {"productId": "12345678-prod-0002-1234-abcdefghijkl", "name": "Test User2", "email": "test.user2@gmail.com", "userId": "12345678-user-0002-1234-abcdefghijkl", "quantity": 1, "state": "reserved", "reservationId": '12345678-resv-0003-1234-abcdefghijkl', "listId": '12345678-list-0001-1234-abcdefghijkl', "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "listTitle": 'Child User1 1st Birthday', "productType": 'products'}
            ]
        }
...
class TestGetSharedListMain:
    def test_get_shared_list_main(self, monkeypatch, api_get_shared_list_event, dynamodb_mock):
        ...
        assert p["12345678-prod-0002-1234-abcdefghijkl"] == {"productId": "12345678-prod-0002-1234-abcdefghijkl", "quantity": 1, "reserved": 0, "purchased": 0, "type": "products", "notes": "I would like size medium."}, "Product object not correct."
        ...
        expected_reservation = {
            "12345678-notf-0010-1234-abcdefghijkl": {
                "12345678-user-0002-1234-abcdefghijkl": [{
                    "reservationId": "12345678-resv-0004-1234-abcdefghijkl", "productId": "12345678-notf-0010-1234-abcdefghijkl", "userId": "12345678-user-0002-1234-abcdefghijkl", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User2", "email": "test.user2@gmail.com", "quantity": 1, "state": "reserved", "listTitle": "Child User1 1st Birthday", "productType": "notfound"
                }]
            },
            "12345678-prod-0001-1234-abcdefghijkl": {
                "12345678-user-0002-1234-abcdefghijkl": [{
                    "reservationId": "12345678-resv-0001-1234-abcdefghijkl", "productId": "12345678-prod-0001-1234-abcdefghijkl", "userId": "12345678-user-0002-1234-abcdefghijkl", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User2", "email": "test.user2@gmail.com", "quantity": 1, "state": "reserved", "listTitle": "Child User1 1st Birthday", "productType": "products"
                }],
                "12345678-user-0003-1234-abcdefghijkl": [{
                    "reservationId": "12345678-resv-0002-1234-abcdefghijkl", "productId": "12345678-prod-0001-1234-abcdefghijkl", "userId": "12345678-user-0003-1234-abcdefghijkl", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User3", "email": "test.user3@gmail.com", "quantity": 1, "state": "reserved", "listTitle": "Child User1 1st Birthday", "productType": "products"
                }]
            },
            "12345678-prod-0003-1234-abcdefghijkl": {
                "test.user99@gmail.com": [{
                    "reservationId": "12345678-resv-0003-1234-abcdefghijkl", "productId": "12345678-prod-0003-1234-abcdefghijkl", "userId": "test.user99@gmail.com", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User99", "email": "test.user99@gmail.com", "quantity": 1, "state": "reserved", "listTitle": "Child User1 1st Birthday", "productType": "products"
                }]
            },
            "12345678-prod-0004-1234-abcdefghijkl": {
                "12345678-user-0002-1234-abcdefghijkl": [{
                    "reservationId": "12345678-resv-0006-1234-abcdefghijkl", "productId": "12345678-prod-0004-1234-abcdefghijkl", "userId": "12345678-user-0002-1234-abcdefghijkl", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User2", "email": "test.user2@gmail.com", "quantity": 1, "state": "purchased", "listTitle": "Child User1 1st Birthday", "productType": "products"
                }]
            },
            "12345678-prod-0005-1234-abcdefghijkl": {
                "test.user99@gmail.com": [{
                    "reservationId": "12345678-resv-0007-1234-abcdefghijkl", "productId": "12345678-prod-0005-1234-abcdefghijkl", "userId": "test.user99@gmail.com", "listId": "12345678-list-0001-1234-abcdefghijkl", "listOwnerId": '12345678-user-0001-1234-abcdefghijkl', "name": "Test User99", "email": "test.user99@gmail.com", "quantity": 1, "state": "purchased", "listTitle": "Child User1 1st Birthday", "productType": "products"
                }]
            }
        }
